...
last_updated: '2026-04-11T11:56:23Z'
as_of: '2026-04-09'
owners:
- wiki-system
source_count: 0
...
<!-- para: para_001 -->
Polymarket의 `markets` 엔드포인트에 `limit=50`을 적용해 활성 마켓의 현재 상태를 확인했습니다. 응답에는 여러 binary market이 포함되어 있었고, 각 마켓의 `id`, `description`, `status` 값도 함께 확인할 수 있었습니다.
