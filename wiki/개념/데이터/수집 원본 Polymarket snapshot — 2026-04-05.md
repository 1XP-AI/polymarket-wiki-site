...
last_updated: '2026-04-10T16:33:28Z'
as_of: '2026-04-09'
owners:
- wiki-system
source_count: 0
...
<!-- para: para_001 -->
Polymarket의 `markets` 엔드포인트에 `limit=50`을 적용해 활성 마켓의 스냅샷을 조회했습니다. 응답에는 여러 개의 binary market가 포함되어 있었고, 각 마켓의 `id`, `description`, `status` 값도 함께 확인할 수 있었습니다.
