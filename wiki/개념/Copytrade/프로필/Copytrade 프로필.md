...
<!-- para: para_002 -->
프로필 군집은 일반 평가 기준, 템플릿, 사례 문서를 분리해 읽도록 설계되어야 한다.
...
<!-- para: para_004 -->
프로필 기준 문서군: [[트레이더 프로필 분석]]

## 평가 템플릿

<!-- para: para_005 -->
평가 템플릿 문서군: [[트레이더 프로필 템플릿]]

## 사례 문서

<!-- para: para_006 -->
사례 문서 문서군: [[0x492442eab586f242b53bda933fd5de859c8a3782 트레이더 프로필]], [[Theo — 트레이더 프로필 사례]]

## 탐색 경로

<!-- para: para_007 -->
먼저 `트레이더 프로필 분석`으로 기준을 잡고, 이후 템플릿과 사례 문서를 읽는 흐름이 좋다.
