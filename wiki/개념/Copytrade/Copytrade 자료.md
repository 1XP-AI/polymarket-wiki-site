...
type: concept
status: verified
created_at: '2026-04-11T12:55:34Z'
last_updated: '2026-04-11T12:55:35Z'
as_of: '2026-04-11'
owners:
- wiki-system
source_count: 0
...
<!-- para: para_001 -->
> Copytrade 관련 시점성 스냅샷과 raw 참고 자료를 묶는 하위 허브 문서

<!-- para: para_002 -->
자료 군집은 개념 설명보다 시점 추적과 근거 확인에 쓰는 문서이므로, 참고용 자료와 핵심 설명 문서를 분리해 보여줘야 한다.

## 문서 지도

<!-- para: para_003 -->
이 허브는 하위 문서를 역할별로 나눠 읽는 순서를 보여준다.

## 시점성 문서 구분

<!-- para: para_004 -->
시점성 문서 구분 문서군: [[Polymarket 리더보드 스냅샷 (2026-04-05 01:00)]], [[Polymarket 이벤트 스냅샷 (2026-04-05)]]

<!-- para: para_005 -->
시점성 문서는 특정 시점의 상태를 보존하는 참고 자료이므로, 일반 개념 문서보다 보조 자료로 취급한다.

## 수집 메모와 참고 자료

<!-- para: para_006 -->
수집 메모와 참고 자료 문서군: [[2026-04-06 Copytrade 외부 소스 수집]], [[Copytrade 링크 강화]], [[Polymarket Copytrade 위키 — Raw 자료 인덱스]]

<!-- para: para_007 -->
이 섹션은 raw 근거와 외부 수집 메모를 보관하는 용도이며, 핵심 설명 문서와는 분리해서 읽는 편이 좋다.

## 탐색 경로

<!-- para: para_008 -->
핵심 개념은 `Copytrade` 허브에서 읽고, 근거 확인이 필요할 때만 자료 문서군으로 내려가는 편이 좋다.
