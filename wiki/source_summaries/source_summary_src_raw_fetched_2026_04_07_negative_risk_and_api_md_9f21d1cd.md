---
id: source_summary_src_raw_fetched_2026_04_07_negative_risk_and_api_md_9f21d1cd
title: 'Source Summary: 2026-04-07 Negative Risk & CLOB API 외부 소스 수집'
type: source_summary
status: verified
...
# Source Summary: 2026-04-07 Negative Risk & CLOB API 외부 소스 수집
...
- Description: Polymarket Multi-Outcome Markets. The contracts unify mutually exclusive binary markets into a single multi-outcome market structure.
...
- Title: Polymarket processes $1.4B as NegRisk outshines CTF markets
- Description: Polymarket's unique active users surged to 8,600 in a single day; NegRisk mechanism processing $1.4B volume outshining CTF markets.

<!-- para: para_005 -->
- URL: https://tokention.com/polymarket-processes-1-4b-as-negrisk-outshines-ctf-markets/
- Title: Polymarket processes $1.4B as NegRisk outshines CTF markets
- Description: Platform supports two types — CTF and negative risk markets. Both serve different purposes for distinct event types.
